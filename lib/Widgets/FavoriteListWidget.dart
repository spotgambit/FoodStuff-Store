...
import 'package:groceryshop/Widgets/BottomSheets/ProductDescriptionBottomSheetWidget.dart';
...
class _FavoriteListWidgetState extends State<FavoriteListWidget> {
  ...
  void _openProductDescBottomSheet(String image, String name, double discount, String category){
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      builder: (_) => ProductDescriptionBottomSheetWidget(image: image, name: name, discount: discount, category: category),
    );
  }
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: GestureDetector(
                            onTap: (){
                              _openProductDescBottomSheet(product['image'], product['name'], product['discount'], product['category']);
                            },
                            child: Image.network(
                              product['image'],
                              height: 70,
