...
class ConfirmMediaAccessBottomSheetWidget extends StatefulWidget {
  const ConfirmMediaAccessBottomSheetWidget({super.key});

  @override
  State<ConfirmMediaAccessBottomSheetWidget> createState() => _ConfirmMediaAccessBottomSheetWidgetState();
}

class _ConfirmMediaAccessBottomSheetWidgetState extends State<ConfirmMediaAccessBottomSheetWidget> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  FittedBox(
                    fit: BoxFit.scaleDown, // Shrinks the text to fit the available space
                    child: Text(
...
class ScreenContext {
  ...
  static const String labelText = "Allow gallery access";
  static const List<String> headerText = ["Give Fundre AI images to search",];
  static const String bodyText = "Your audio and mic on your device will be turned on automatically. We store and use the transcripts. view ";
